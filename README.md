...
## 🗺️ Live Threat Detection Dashboard
...
1. **Ingestion Layer:** Deployed a public-facing cloud compute layer as a decoy target. Activated **AWS VPC Flow Logs** to monitor raw network traffic and connection frames.
...
4. **Visual Mapping Layer:** Downstream analytics ingest the structural metadata directly into an interactive dark-mode geolocation map (`index.html`) to pinpoint threat origins instantly.
...
* **Frontend Dashboard:** HTML5, JavaScript, CSS3 (Interactive Mapping Engine)
...
Building this project provided intensive hands-on experience managing infrastructure automation, evaluating real-time server security configurations, parsing structured network telemetry frames, and applying zero-trust identity policies to live public infrastructure.
